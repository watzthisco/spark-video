...
var SparkPlugin = _ampersandState2.default.extend({
  ...
  initialize: function initialize() {
    ...
    (0, _apply2.default)(_ampersandState2.default.prototype.initialize, this, attrs);

    // Propagate change:[attribute] events from children
    this.on('change', function (model, options) {
      _this2.parent.trigger('change:' + _this2.namespace.toLowerCase(), _this2.parent, _this2, options);
    });
  },
