...
var Credentials = _credentialsBase2.default.extend({
  authorize: (0, _common.oneFlight)('authorize', function authorize(options) {
    /* eslint complexity: [0] */
    /* eslint camelcase: [0] */
...
//# sourceMappingURL=credentials.shim.js.map
