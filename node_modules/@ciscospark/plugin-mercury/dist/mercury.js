...
var Mercury = _sparkCore.SparkPlugin.extend({
  namespace: 'Mercury',
  ...
  connect: (0, _common.oneFlight)('connect', function connect() {
    var _this = this;
  ...
  disconnect: (0, _common.oneFlight)('disconnect', function disconnect() {
    var _this2 = this;
  ...
  listen: _util2.default.deprecate(function listen() {
    /* eslint no-invalid-this: [0] */
    return this.connect();
  }, 'Mercury#listen(): Use Mercury#connect() instead'),

  stopListening: _util2.default.deprecate(function stopListening() {
    /* eslint no-invalid-this: [0] */
