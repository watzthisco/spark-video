 ...
 * @extends SparkPlugin
 */
var Call = _sparkCore.SparkPlugin.extend({
  namespace: 'Phone',
   ...
   * @returns {Promise}
   */
  _hangup: (0, _common.oneFlight)('hangup', function _hangup() {
    var _this7 = this;
   ...
   * @returns {Promise}
   */
  reject: (0, _common.oneFlight)('reject', function reject() {
    var _this8 = this;
  ...
  _updateMedia: (0, _common.oneFlight)('_updateMedia', function _updateMedia() {
    var _this12 = this;
