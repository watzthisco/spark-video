...
import {
  ...
  joined,
  joinedOnThisDevice,
  mediaDirection as mediaDirectionFromLocus,
  participantIsJoined,
  remoteAudioMuted,
  remoteParticipant,
  remoteVideoMuted
...
<<<<<<< 9af2e7820e6489954a7fe168f6141f9779e516c8
    /**
...
>>>>>>> fix(plugin-phone): update locus and linus correctly on media change
  },
  ...
  derived: {
    ...
    remoteAudioDirection: {
      deps: [`locus`],
      fn() {
        return mediaDirectionFromLocus(`audio`, this.remote).toLowerCase();
      }
    },
    remoteVideoDirection: {
      deps: [`locus`],
      fn() {
        return mediaDirectionFromLocus(`video`, this.remote).toLowerCase();
      }
    }
  },
